...
SRC_DIR		:= src
SRC			:= push_swap.c input_handling.c basic_stack.c rotate_stack.c list_tools.c list_checks.c error.c print_return.c sorting.c free_stack.c convert_input.c printing.c
